  ...
  - block: collection
    content:
      ...
      text: |
        ...
        <div style="background-color:rgba(0, 0, 0, 0.0470588); text-align:center; vertical-align: middle; padding:40px;">
        ...
        <a href="/blog">VIEW THE BLOG</a>
                ...
                <div style="background-color:rgba(0, 0, 0, 0.0470588); text-align:center; vertical-align: middle; padding:40px 40px 40px 40px; margin-top:30px">
        <a href="/blog">VIEW THE BLOG 2</a>
        </div>
